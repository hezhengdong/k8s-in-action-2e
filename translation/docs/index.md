...
随着 Kubernetes 生态系统的快速演进，第二版势在必行。这一次，Marko 与 Kevin 结为合著者，基于他们共同的实践经验。本书的篇幅随 Kubernetes 自身一同增长，因此《Kubernetes in Action, Second Edition》聚焦于**为 Kubernetes 开发应用和在 Kubernetes 上开发应用**的基础知识。

希望这本书能帮助您高效驾驭 Kubernetes，并享受这个过程。
